                                ...
                                <div class="select-position">
                                    <form action="{{ route('currency.store') }}" method="post">
                                        ...
                                        <select name="currency_code" onchange="this.form.submit()">
                                            <option value="EGP" @selected('EGP' == session('currency_code'))>$ EGP
                                            </option>
                                    ...
                                    <form action="{{ URL::current() }}" method="get">
                                        <select name="locale" onchange="this.form.submit()">
                                            @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                                <option
                                                    value="{{$localeCode}}" @selected($localeCode == App::currentLocale())>{{$properties['native']}}</option>
                                            @endforeach
                                        </select>
                                    </form>
                                </div>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="top-middle">
                        <ul class="useful-links">
                            ...
                            <li><a href="contact.html">{{ trans('app.contact') }}</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="top-end">
                        ...
                        @else
                            ...
                            <ul class="user-login">
                                <li>
                                    <a href="{{route('login')}}">{{ __('app.sign_in') }}</a>
                                </li>
                                <li>
